    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated', models.DateTimeField(auto_now=True, null=True)),
                ('audited_data_purchase_min', models.DecimalField(blank=True, decimal_places=2, default='-10', max_digits=5, null=True)),
                ('audited_data_purchase_max', models.DecimalField(blank=True, decimal_places=2, default='10', max_digits=5, null=True)),
                ('audited_data_stock_min', models.DecimalField(blank=True, decimal_places=2, default='-10', max_digits=5, null=True)),
                ('audited_data_stock_max', models.DecimalField(blank=True, decimal_places=2, default='10', max_digits=5, null=True)),
                ('audited_data_price_min', models.DecimalField(blank=True, decimal_places=2, default='-10', max_digits=5, null=True)),
                ('audited_data_price_max', models.DecimalField(blank=True, decimal_places=2, default='10', max_digits=5, null=True)),
                ('audited_data_sales_min', models.DecimalField(blank=True, decimal_places=2, default='-10', max_digits=5, null=True)),
                ('audited_data_sales_max', models.DecimalField(blank=True, decimal_places=2, default='10', max_digits=5, null=True)),
                ('outlet_factor_numaric_min', models.DecimalField(blank=True, decimal_places=2, default='0', max_digits=5, null=True)),
                ('outlet_factor_numaric_max', models.DecimalField(blank=True, decimal_places=2, default='1', max_digits=5, null=True)),
