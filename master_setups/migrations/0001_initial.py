    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master_setups.Country')),
                ('district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master_setups.District')),
            ],
            options={
                'verbose_name': 'Tehsil',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True, null=True)),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master_setups.Country')),
                ('player', models.ManyToManyField(to='master_setups.Player')),
                ('tag', models.ManyToManyField(to='master_setups.Tag')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='district',
            name='province',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master_setups.Province'),
        ),
        migrations.CreateModel(
            name='CountrySetting',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master_setups.Country')),
                ('player_tag', models.ManyToManyField(to='master_setups.PlayerTag')),
                ('tehsil', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master_setups.Tehsil')),
            ],
            options={
