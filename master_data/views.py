...
class CensusListView(LoginRequiredMixin, generic.TemplateView):
    ...
    #     # queryset = Census.objects.values_list('censusdata',flat=True)[:2]

    #     data = []
    #     cols = []
    #     queryset = Census.objects.values_list('censusdata',flat=True)[:3]

    #     # for col in queryset:
    #     #     data.append(json.loads(col))
    ...
    #     # for col in queryset:
    #     #     col = json.loads(col)
    #     #     # print(type(census_cols))
    #     #     for k in col:
    #     #         # print(k)
    #     #         # col = k[0:5]
    #     #         cols.append(col)
    #     #         print(col)
    #         # census_cols = json.loads(col)
    #         # census_cols = census_cols.keys()
    ...
    #     # queryset = Census.objects.values('data',flat=True)[:10]

    #     # queryset_values = Census.objects.all().values_list('data_values',flat=True)[:10]
    #     # print(type(list(queryset.values())))
    #     # print(type(queryset_head))

    #     # print(queryset);

    #     # census_cols = list(queryset["data"])
    #     # print(census_cols);
    #     # queryset_json = serializers.serialize('json', queryset)
    #     context.update({
    #         # "census_data": data,
    #         # "census_cols": cols                                                                                                                                                                                                                                                                                         ,
    #         # "census_values": list(values)
    #     })
    #     return context
