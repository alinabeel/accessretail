...
(function ($, document) {
    ...
    $.fn.cloner.options = {
        ...
        //     $clone.find("[name^='fiter[group][row]")
        //     $("[name^='fiter[group][row]").each(function(i) {
        //         console.log($(this).attr("name",$(this).attr("name")+i));
        //         // console.log(this)
        //     });
